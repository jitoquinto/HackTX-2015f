                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-12">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="roster.php" class="small-box-footer">
                      ...
                      <div class="col-lg-3 col-xs-6">
                        <div class="box">
                                ...
                                <div class="box-body">
                                    <p>
                                      <ol>
                                        <?php $fiveLocations = fiveCourts($conn); foreach($fiveLocations as $location) {echo "<li><a href=\"#\">".$location['locName']."</a><p class=\"text-muted\">(".$location['numCourts']." courts)</p></li>";} ?>
                                      </ol>
                                    </p>
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                                    Showing 5 of <?php echo countCourts($conn); ?> available courts.
                                </div><!-- /.box-footer-->
                            </div>
                      </div>
